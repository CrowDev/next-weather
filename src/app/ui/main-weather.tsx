...
export const MainWeather = ({ currentConditions }: Props) => {
	const icon = currentConditions.WeatherIcon < 10 ? `0${currentConditions.WeatherIcon}` : currentConditions.WeatherIcon
	const src = `https://developer.accuweather.com/sites/default/files/${icon}-s.png`
	return (
